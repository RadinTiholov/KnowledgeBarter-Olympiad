...
namespace KnowledgeBarter.Server.Migrations
{
    ...
    [Migration("20230413135743_IncreaseArticleLength")]
    partial class IncreaseArticleLength
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KnowledgeBarter.Server.Data.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KnowledgeBarter.Server.Data.Models.Message", b =>
                {
                    b.HasOne("KnowledgeBarter.Server.Data.Models.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("KnowledgeBarter.Server.Data.Models.ApplicationUser", "Sender")
                        .WithMany()

namespace KnowledgeBarter.Server.Models.Lesson
{
    ...
    public class EditLessonResponseModel : IMapFrom<Lesson>, IHaveCustomMappings
    {
        ...
        {
            configuration.CreateMap<Lesson, EditLessonResponseModel>()
                ...
                .ForMember(x => x.Comments, opt =>
                    opt.MapFrom(i => i.Comments.Select(x => new CommentInListResponseModel() { Id = x.Id, Text = x.Text, LessonId = x.LessonId, OwnerId = x.OwnerId })));
        }
    }
}
